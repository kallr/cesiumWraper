...
using namespace CesiumGltf;
	...
	public:
			...
			std::vector<int>& addedIDs	)
		{
			...
			if (positive[0] == positive[1] && positive[0] == positive[2])//ͬһ��
			{
			...
			else if ((positive[0] == 0 && positive[1] == positive[2]) || (positive[1] == 0 && positive[0] == positive[2]) || (positive[2] == 0 && positive[0] == positive[1]))//һ�������棬������ͬһ��
			{
			...
			else if ((positive[0] == 0 && positive[1] != 0 && positive[1] == positive[2]) || (positive[1] == 0 && positive[2] != 0 && positive[0] == positive[2]) || (positive[2] == 0 && positive[0] != 0 && positive[0] == positive[1]))////һ�������棬������ͬһ��
			{
				int flag = positive[0] + positive[1] + positive[2];
				if (flag > 0) //left
				{
			...
			else if ( (positive[0] == 0 && positive[1] == 0 && positive[2] !=0 ) || (positive[0] == 0 && positive[1] != 0 && positive[2] == 0) ||  (positive[0] != 0 && positive[1] == 0 && positive[2] == 0))////2�������棬1����һ��
			{
				int flag = positive[0] + positive[1] + positive[2];
				if (flag > 0) //left
				{
			...
			else if ((positive[0] == 0 && positive[1] != positive[2]) || (positive[1] == 0 && positive[0] != positive[2]) || (positive[2] == 0 && positive[0] != positive[1]))//һ�������档���������ڲ�ͬ��
			{
	...
	void  DGSplitMeshToQuard(int maxLevel, GMesh& mesh, std::vector< GMesh >& childMeshs)
	{
		...
		if (DZ / dMax > 5 || dMax < ingoreScope)//�ֲ�С����ඥ��ģ�ͣ����з�
		{
			return;
		}
